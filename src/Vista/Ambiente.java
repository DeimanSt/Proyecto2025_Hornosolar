...
public class Ambiente extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 142, -1, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel10.setText("Fecha creacion");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(103, 215, -1, -1));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel9.setText("°");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 90, -1, -1));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel11.setText("Intensidad Solar");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(176, 57, -1, -1));
        ...
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(44, 142, -1, -1));

        txb_direccion.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "", "Norte", "Sur", "Este", "Oeste" }));
        getContentPane().add(txb_direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 170, 130, 40));

        txb_angulo.setModel(new javax.swing.SpinnerNumberModel(0, 0, 360, 1));
        txb_angulo.setName(""); // NOI18N
        getContentPane().add(txb_angulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 90, 100, 30));

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel16.setText("°C");
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 170, -1, -1));

        txb_temperatura.setModel(new javax.swing.SpinnerNumberModel(0, 0, 1000, 1));
        txb_temperatura.setName(""); // NOI18N
        getContentPane().add(txb_temperatura, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 170, 100, 30));

        txb_intensidadsolar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "", "Alta", "Media", "Baja" }));
        getContentPane().add(txb_intensidadsolar, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 90, 140, 40));
